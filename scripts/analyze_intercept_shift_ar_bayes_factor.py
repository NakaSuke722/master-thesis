"""Paired RCAEval analysis for the intercept-shift AR Bayes factor."""
...
COMPARISONS = (
    ("raw", "intercept_shift_ar_bayes_factor"),
    (
        "stationary_counterfactual_ar_uncertainty",
...
def _write_markdown(path: Path, report: dict[str, Any]) -> None:
    lines = [
        ...
        "",
        "Differences are Intercept-shift AR-BF minus baseline with paired "
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        default=Path("results/analysis/intercept_shift_ar_bayes_factor"),
    )
