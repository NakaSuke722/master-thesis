...
\hypersetup{pageanchor=false} % 表紙と本文のpage.1重複を避ける
\maketitle %表紙出力
\pagenumbering{roman}
\hypersetup{pageanchor=true}

% draft0: 研究室内レビュー向けの骨子。根拠ファイルは99_appendix.texのコメントに集約。
% ファイル名は既存構成を維持し、論文の表示順は以下で管理する。
...
\input{sections/90_acknowledgement}
